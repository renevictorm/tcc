...
class ClienteForm extends Component {
    ...
    getVALUE() {
        ...
        const eee = false
        addCliente(nameCliente, emailCliente, telefoneCliente, prefCliente, identidadeCliente, cnpjCliente, cpfCliente, enderecoCliente, captacaoCliente, empresaCliente)
...
const mapStateToProps = state => ({
    ...
    , enderecoCliente: state.cliente.enderecoCliente, captacaoCliente: state.cliente.captacaoCliente, empresaCliente: state.cliente.empresaCliente
})
