...
class NovaFase extends Component {
    ...
    keyHandler(e) {
        const { addFase, nameFase, idProjetoFase, inicioFase, fimFase, fimEsperadoFase, descricaoFase } = this.props
        if (e.key === 'Enter') {
            addFase(nameFase, idProjetoFase, inicioFase, fimFase, fimEsperadoFase, descricaoFase)
        }
    }
    ...
    getVALUE() {
        ...
        addFase(nameFase, isEditProjetoFase, inicioFase, fimFase, fimEsperadoFase, descricaoFase)
    }
    /*
...
const mapStateToProps = state => ({
    ...
    fimEsperadoFase: state.fase.fimEsperadoFase, descricaoFase: state.fase.descricaoFase
})
